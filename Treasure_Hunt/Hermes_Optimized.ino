...
NewPing sonar_1(TRIGGER_PIN_1, ECHO_PIN_1, MAX_DISTANCE);// Obstacles detector on the front
NewPing sonar_2(TRIGGER_PIN_2, ECHO_PIN_2, MAX_DISTANCE);// Obstacles detector on the right
NewPing sonar_3(TRIGGER_PIN_3, ECHO_PIN_3, MAX_DISTANCE);// Obstacles detector on the left
...
void loop() {
  ...
  // Evaluate changes according to 3 sonars
  if (obstacle_dist[0] <=10 && obstacle_dist[0] > 0) {
    digitalWrite(M1, HIGH);
    digitalWrite(M2, HIGH);    
    analogWrite(E1, 120);
    analogWrite(E2, 120);
  ...
  if (obstacle_dist[1] <=5 && obstacle_dist[1] > 0) {
    digitalWrite(M1, LOW);
    digitalWrite(M2, HIGH);
    analogWrite(E1, 150);
    analogWrite(E2, 150);
  ...
  if (obstacle_dist[2] <=5 && obstacle_dist[2] > 0) {
    digitalWrite(M1, HIGH);
    digitalWrite(M2, LOW);
    analogWrite(E1, 150);
    analogWrite(E2, 150);
